...
print(f"DEBUG: DEFAULT_FROM_EMAIL: {os.getenv('DEFAULT_FROM_EMAIL')}")
print(f"DEBUG: CONTACT_EMAIL: {os.getenv('CONTACT_EMAIL')}")
...
# Email Configuration
# Always use console backend for debugging
...
EMAIL_HOST_PASSWORD = os.getenv('SENDGRID_API_KEY')  # From environment variable
...
print(f"Using SendGrid: {'sendgrid' in str(EMAIL_BACKEND).lower()}\n")
